...
use crate::fuz::helpers::Sys as fuzSys;
use crate::lusgen::helpers::Sys as pidSys;
...
#[no_mangle]
pub extern "C" fn InitLustrePID(raw_ptr: *mut lusgen::PID, input: f64, now: f64, setpoint: f64, Kp: f64, Ki: f64, Kd: f64, sampleTime:f64) {
    ...
    *PIDC_ref = lusgen::PID::read_init(inputArray)  // Place struct in deferenced location PIDC_ref

}

#[no_mangle]
pub extern "C" fn ComputeLustrePID(raw_ptr: *mut lusgen::PID, input: f64, now: f64, setpoint: f64, Kp: f64, Ki: f64, Kd: f64, sampleTime:f64) -> f64 {
    ...
    lusgen::PID::read_next(PIDC_ref, inputArray);
    let output_tuple = lusgen::PID::output(PIDC_ref); 
...
#[no_mangle]
pub extern "C" fn ComputeLustreFUZ(raw_ptr: *mut fuz::FUZ, input: f64, now: f64, setpoint: f64, Kp: f64, Ki: f64, Kd: f64, sampleTime:f64) -> f64 {
    ...
    fuz::FUZ::read_next(PIDC_ref, inputArray);
    let output_tuple = fuz::FUZ::output(PIDC_ref); 
